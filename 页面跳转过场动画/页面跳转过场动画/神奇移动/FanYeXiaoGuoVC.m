...
#import "Masonry.h"
#import "ErJiViewController.h"
#import "UIView+anchorPoint.h"

@interface FanYeXiaoGuoVC ()<UIViewControllerAnimatedTransitioning,UINavigationControllerDelegate>
...
- (IBAction)pushClick:(UIButton *)sender {
    ...
    [self.navigationController pushViewController:[[NSClassFromString(@"ErJiViewController") alloc] init] animated:YES];
}
